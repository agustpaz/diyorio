...
const QuienesSomos = () => {
  ...
  return (
    <section id='quienes-somos' className={`sm:grid sm:grid-cols-2 gap-5 p-14`}>
        <div className='px-8 pb-20 xl:px-28flex flex-col items-center wow fadeInUp' data-wow-duration="1s" data-wow-delay="0.5s">
            <div className={`mt-16 ${homeStyles.imagen_planisferio}`}>
                ...
                <p className='text-2.5xl xl:text-2.5xl text-center'>
        ...
        <div className='w-full h-full flex items-center'>
            <div className={`${homeStyles.imagen_puerto} w-full rounded-full shadow-2xl flex justify-center items-center relative`}>
                ...
                <div className='absolute w-full h-full bg-black/50 rounded-full z-10'></div>
            </div>
        </div>
            ...
            <div className={`${homeStyles.imagen_puerto} w-full rounded-full shadow-2xl flex justify-center items-center relative`}>
                <div className='grid grid-cols-2 gap-4 z-20'>
                    ...
                    <Contador
                        initialValue={70}
                        targetValue={100}
                        leyenda={"Porciento de nuestros clientes nos recomiendan"}
                        milisegundos={50}
                        id={"porciento"}
                    />
                </div>
