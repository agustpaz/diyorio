    ...
    <article className={`w-full relative z-20`} >
      <div className="w-full h-full grid lg:grid-cols-3 gap-16 p-20">
          ...
          <div className={`card`}>
            ...
            <div className="card-description">
              <div className='w-full h-full flex flex-col justify-center items-center text-1xl'>
                <p className='text-center'>- Sistema de Importaciones de la Republica Argentina (SIRA).</p>
                <p className='text-center'>- Confección y tramitación de despachos de importación.</p>
                <p className='text-center'>- Asesoramiento y gestión en regímenes especiales (importaciones temporales, reimportaciones, entre otros).</p>
                <p className='text-center'>- Asesoramiento en tratamiento arancelario, aranceles preferenciales y excepciones.</p>
              </div>
            </div>
          </div>
        </Link>
        ...
        <div className={`card`}>
          ...
          <div className="card-description">
            <div className='w-full h-full flex flex-col justify-center items-center text-1xl'>
              <p className='text-center'>- Confección y tramitación de permisos de exportación.</p>
        ...
        <div className={`card`}>
          ...
          <div className="card-description">
            <div className='w-full h-full flex flex-col justify-center items-center text-1xl'>
              <p className='text-center'>- Tramite de inscripción como importador/exportador.</p>
              <p className='text-center'>- Clasificación arancelaria, análisis de costos, aranceles y presupuestos.</p>
              <p className='text-center'>- Contratación de fletes. Reserva en buques. Servicio logístico internacional integrado.</p>
              <p className='text-center'>- Tramitación ante terceros organismos. (INAL, ANMAT, SENASA, entre otros).</p>
              <p className='text-center'>- Manejo de plataforma TAD.</p>
              <p className='text-center'>- Asesoramiento normativo y requisitos sobre la mercadería a comercializar.</p>
              <p className='text-center'>- Coordinamos y supervisamos de forma presencial todas nuestras operaciones.</p>
            </div>
          </div>
        </div>
        </Link>
